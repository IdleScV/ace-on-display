  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.rpc("submit_public_entry", {
        ...
        _yardage: yardage ? Number(yardage) : null,
        _club: club || null,
        _story: story || null,
        _handicap_at_time: handicap ? Number(handicap) : null,
        _favorite_hole: favHole ? Number(favHole) : null,
        _years_playing: yearsPlaying ? Number(yearsPlaying) : null,
        _prior_holes_in_one: priorAces ? Number(priorAces) : null,
        _golfer_email: email || null,
